""" Personalized training script """
# credit: modified from https://github.com/mlfoundations/open_flamingo/blob/main/open_flamingo/train/train.py
...
from open_flamingo.open_flamingo.train.train_utils import (
    train_one_epoch,
    get_mp_policy_dtype,
    save_checkpoint,
)
...
def main():
    ...
    parser.add_argument("--num_epochs", type=int, default=1, help="we define an 'epoch' as a fixed number of examples (train_num_samples_mmc4, train_num_samples_laion), not a pass through the entire dataset",)
    ...
    # Initialize model
    model, image_processor, tokenizer = create_model_and_transforms(args.vision_encoder_path,
